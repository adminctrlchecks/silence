...
- [ ] Public navbar + footer per [07-navigation-architecture.md](07-navigation-architecture.md) — footer must include legal links (P0, since Terms/Privacy don't exist yet, link them now and build the pages in Phase 8).
