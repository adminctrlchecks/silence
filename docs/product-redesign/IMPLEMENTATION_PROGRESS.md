...
| Phase 3 | Satisfy how-it-works content on homepage instead of adding a duplicate page | `docs/product-redesign/IMPLEMENTATION_PROGRESS.md` | Homepage includes `#how-it-works` ordered 5-step section verified in previous Phase 3 smoke; no standalone route added because spec says only if not fully absorbed | pending |
